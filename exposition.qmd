...
|-------------------------------------|-------|---------------------------------------------|
| **Video Clarity & Structure**       | 2     | Clear audio/video, structured explanation   |
| **Demonstration Quality**           | 2     | Effective use of examples and live demo     |
| **Blog Depth & Clarity**            | 3     | Well-explained concepts with screenshots    |
| **Code Examples**                   | 2     | Working, well-commented, and relevant       |
