...
## Suggested Video Requirements (4 min)

You are free to choose based on your topic and presentation style. The following is one such suggested template.

### 1. **Introduction (30 sec)**
- Briefly introduce the tool/library/framework AND/OR the problem being solved.
...
Below is a suggestive organisation. Your topic may not need these or may need some additional. Improvise where necessary.
...
- Use a **Jupyter Notebook** or **Markdown-based site** (e.g., Jekyll) or **Quarto** etc.
